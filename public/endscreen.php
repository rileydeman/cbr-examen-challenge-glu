    ...
    <main>
        <div id="parentContainer">
            ...
            <div id="div2">
                <div id="resultContainer">
                    ...
                    ?>
                        ...
                        <img id="failImage" src="./public/assets/img/gefaald.png" style="width:300px;height:300px;object-fit:contain;">
                </div>
            <?php
            ...
            ?>
                ...
                <img id="passImage" src="./public/assets/img/geslaagd.png" style="width:300px;height:300px;object-fit:contain;">
            </div>
                ...
                <style>
                    .important-word3 {
                        ...
                        //Maar denk dat de variabelen wel genummerd moeten blijven. Maar ja jij bent de expert dus doe lekker je ding :)
                            ?>
            <p class="hvlVragenFout">Gevaarherkenning: <span class="important-word"><?= $vragenFout . " van de " . $vragenTotaal . " fout." ?></span>
            </p>
            <p class="hvlVragenFout">Kennis: <span class="important-word2"><?= $vragenFout2 . " van de " . $vragenTotaal2 . " fout." ?></span>
            </p>
            <p class="hvlVragenFout">Inzicht: <span class="important-word3"><?= $vragenFout3 . " van de " . $vragenTotaal3 . " fout." ?></span>
            </p>
            <br>
            <br>
            <?php
